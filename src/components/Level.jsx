...
import { Exhibits } from 'src/components/Exhibits';
import { Podiums } from 'src/components/Podiums';
import { Floors } from 'src/components/Floors';
...
export function Model(props) {
  ...
  const { animations, scene, cameras } = useGLTF('models/model.gltf');
  ...
  console.log('mixer.current.time', mixer.current.time);
  const {
    exhibitsVisible,
    wallsVisible,
    touchPadSpeed,
