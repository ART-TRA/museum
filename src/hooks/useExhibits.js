export const useExhibits = () => {
  return {
    ...
    art: {
      ...
      description:
        'Тема урока, на&nbsp;котором нарисован этот рисунок, называлась &laquo;Твоя мечта&raquo;. Автор вряд&nbsp;ли верил, что она действительно исполниться. Но&nbsp;теперь рисунок&nbsp;&mdash; достояние музея, а&nbsp;изображенное на&nbsp;нём&nbsp;&mdash; реальность.',
    },
    xylophone: {
      title: 'Ксилофон',
      description:
